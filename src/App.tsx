...
import { AllMissions, AllChapters, Difficulty } from './context';
...
function App() {
  ...
  return (
    <AllMissions value={allMissions}><AllChapters value={allChapters}><Difficulty value={useState<number>(1)}>
      <div className="App">
    ...
    </Difficulty></AllChapters></AllMissions>
  );
}
